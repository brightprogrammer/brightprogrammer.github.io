---
title: The AMD64 (x86_64) Instruction Encoding Format
date: 2023-03-01 18:44:09
tags: ['x86_64', 'amd64', 'instruction-set', 'intel', 'amd', 'disassembler']
categories: ['disassembler', 'amd64']
---
...
![Figure 1-2 (AMD Vol3 Page5)](/images/screenshot-from-2023-03-02-00-42-24.png "Figure showing general layout of an AMD64 Instruction (AMD Vol3 Page5)")
...
![Fig 1-3 (AMD Vol3 Page15)](/images/screenshot-from-2023-03-01-23-21-21.png "Layout of REX prefix byte (AMD Vol3 Page15)")
...
![(AMD Vol3 Page17)](/images/screenshot-from-2023-03-01-19-02-58.png "Diagram of the ModRM byte (AMD Vol3 Page17)")
...
![Table 1-10 (AMD Vol3 Page18)](/images/screenshot-from-2023-03-01-23-32-13.png "Table showing different values of ModRM fields to index different registers (AMD Vol3 Page18)")
...
![Figure 2-3 (AMD Vol3 Page39)](/images/screenshot-from-2023-03-01-23-39-34.png "Table displaying the GPRs and their format (AMD Vol3 Page39)")
...
![(AMD Vol3 Page83)](/images/screenshot-from-2023-03-01-23-48-48.png "Table showing all possible ADD opcodes and their description (AMD Vol3 Page83)")
...
![Table 1-10 (AMD64 Vol3 Page18)](/images/screenshot-from-2023-03-01-23-32-13.png "Table displaying different values of ModRM.r or ModRM.rm field (AMD64 Vol3 Page18)")

A﻿n `SIB` byte is present only if the mode is register-indirect and `ModRM.rm` value is `100b`. 

![Figure 1-5 (AMD Vol3 Page19)](/images/screenshot-from-2023-03-02-00-49-09.png "Diagram displaying different fields of SIB byte (AMD Vol3 Page19)")

![Table 1-11 (AMD Vol3 Page19)](/images/screenshot-from-2023-03-02-00-50-23.png "Table showing different SIB.sacle value encodings (AMD Vol3 Page19)")
...
![Table 1-12 (AMD Vol3 Page20)](/images/screenshot-from-2023-03-02-00-56-19.png "SIB.index and SIB.base Field Encodings (AMD Vol3 Page20)")

![Table 1-13 (AMD Vol3 Page20)](/images/screenshot-from-2023-03-02-00-57-59.png "SIB.base encodings for ModRM.r/m = 100b (AMD Vol3 Page20)")

![Table 1-14 (AMD Vol3 Page21)](/images/screenshot-from-2023-03-02-01-10-02.png "Operand Addressing Using ModRM and SIB Bytes (AMD Vol3 Page21)")
...
![Table 1-1 (AMD Vol3 Page7)](/images/screenshot-from-2023-03-01-18-42-05.png "Table showing all legacy prefix bytes with their meaning and names (AMD Vol3 Page7)")
...
![Table 1-2 (AMD Vol3 Page8)](/images/screenshot-from-2023-03-02-00-15-40.png "Table showing the different operand size overrides when this prefix is present (AMD Vol3 Page8)")
...
![Table 1-3 (AMD Vol3 Page9)](/images/screenshot-from-2023-03-02-00-23-13.png "Table showing effective address size in different cases (AMD Vol3 Page9)")
...
![Table 1-5 (AMD Vol3 Page11)](/images/screenshot-from-2023-03-02-00-26-45.png "Table showing different segment override prefixes (AMD Vol3 Page11)")
...
![Figure 1-1 (AMD Vol3 Page2)](/images/screenshot-from-2023-03-02-00-34-12.png "Control flow diagram of a simple algorithm to decode instructions (AMD Vol3 Page2)")
