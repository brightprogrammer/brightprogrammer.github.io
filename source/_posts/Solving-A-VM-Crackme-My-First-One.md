---
title: Solving A VM Crackme - My First One!
date: 2021-12-27 14:13:01
...
![working of basic computer](/images/firstcm-abasiccomputer.gif)
...
We'll use a new tool **Iaito**. Iaito is the GUI version of radare. We'll use this to quickly get to the dispatcher function and then we can switch to any other tool.

![entry point](/images/firstcm-entry.png)
...
![main cfg](/images/firstcm-main.png "high level view of main")
...
![overview](/images/firstcm-overview.png)
...
![](/images/firstcm-1.png "call to dispatcher in main")
...
![](/images/firstcm-4.png "head block of dispatcher function")
...
![](/images/firstcm-12.png)

Let's analyze these two functions.

![](/images/firstcm-13.png "this gets high nibble from a byte")

![](/images/firstcm-14.png "getting lower 4 bits of given byte")
...
![](/images/firstcm-18.png "This set looks completely different")
...
![](/images/firstcm-19.png "some new fields are used here")
