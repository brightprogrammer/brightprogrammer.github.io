...
date: 2023-04-12T08:11:25+05:30
description: "RzIL Notes With Examples"
tags: [rizin, intermediate-language, notes, il-uplifter]
...
* There are three different types of `RzILOpPure` operations, meaning three different types of operations in RzIL that evaluate to three completely different types of values, you can find all these definitions in [`rz_il_opcodes.h#L41`](https://github.com/rizinorg/rizin/blob/9ab709bc34843f04ffde3b63322c809596123e77/librz/include/rz_il/rz_il_opcodes.h#L41) :  
...
|-------------------------------------------------------------------|
| taken from [felixcloutier](https://www.felixcloutier.com/x86/div) |  
